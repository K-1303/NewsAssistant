...
def add_urls_summarization():
    ...
    if request.method == 'POST':
        ...
        if(news_summarization_url != ""):
            ...
            return render_template_string(open("templates/index.html").read(), news_urls=news_urls_question, summary=summary)  # Render the index.html template with summary data
